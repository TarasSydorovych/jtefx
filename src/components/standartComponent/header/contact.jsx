    ...
    <section className={css.contactWrap}>
      <div className={css.smallWrap}>
        ...
        <p className={css.smallDescContact}>
          Вітаємо в JTEFX. Ми забезпечуємо найактуальніші можливості для тих,
          хто шукає роботу, або талановитих професіоналів. За допомогою нашої
          платформи обміну трафіком, ви можете ефективно купувати та продавати
          цінний інтернет-трафік. Приєднуйтесь до нас та розкрийте потенціал
          нових можливостей і партнерств.
        </p>
