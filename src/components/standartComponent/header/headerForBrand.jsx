          ...
          <nav className={css.navStyle}>
            <ul className={css.navUlHr}>
              ...
              <Link to="/pay" className={css.navLi}>
                <li className={css.navLi}>Оплата</li>
              </Link>
            </ul>
          </nav>
      ...
      {burgerCLick && (
        <div className={css.burgerMenuWrap}>
          ...
          <ul className={css.listStyle}>
            ...
            <Link to="/brand/request" className={css.listLi}>
              <li className={css.listLi}>Мої заявки</li>
            </Link>
            <Link to="/brand/add" className={css.listLi}>
              <li className={css.listLi}>Додати заявку</li>
            </Link>
            <Link to="/brand/allRequest" className={css.listLi}>
              <li className={css.listLi}>Заявки</li>
            </Link>
            <Link to="/request/my" className={css.listLi}>
              <li className={css.listLi}>Запити</li>
            </Link>
            <Link to="/chat" className={css.listLi}>
              <li className={css.listLi}>Чат</li>
            </Link>
            <Link to="/pay" className={css.listLi}>
              <li className={css.listLi}>Оплата</li>
            </Link>
            <Link to="/profile" className={css.listLi}>
              <li className={css.listLi}>Профіль</li>
            </Link>
          </ul>
        </div>
      )}
